...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'reading_time'          => 'Час прочитання',
        'time_preparing'        => 'Час приготування',
        'count_feed'            => 'Кількість порцій',
        'category'              => 'Категорії',
        'ingredients'           => 'Інгредієнти',
        'ingredients.*.ingredient_id' => 'Інгредієнт',
        'ingredients.*.count'   => 'Кількість інгредієнту',
        'ingredients.*.unit'    => 'Одиниці виміру',
        'steps'                 => 'Кроки рецепта',
        'steps.*.title'         => 'Назва кроку',
        'steps.*.body'          => 'Опис кроку',
        'user_id'               => 'Користувач'
    ],
];
